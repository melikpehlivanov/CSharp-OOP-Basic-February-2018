...
public class Program
{
    public static void Main()
    {
        ...
        FillHospital(command, departments, doktori);
        command = Console.ReadLine();
        PrintResult(command, departments, doktori);

    }

    public static void FillHospital(string command, Dictionary<string, List<List<string>>> departments,
        Dictionary<string, List<string>> doktori)
    {
    ...
    public static void PrintResult(string command, Dictionary<string, List<List<string>>> departments,
        Dictionary<string, List<string>> doktori)
    {
        while (command != "End")
        {
