...
public class Potato
{
    static void Main(string[] args)
    {
        ...
        TheftResults(vhod, seif, torba, zlato, kamuni, mangizi);

        PrintResult(torba);
    }

    public static void PrintResult(Dictionary<string, Dictionary<string, long>> torba)
    {
    ...
    public static void TheftResults(long vhod, string[] seif, Dictionary<string, Dictionary<string, long>> torba, long zlato, long kamuni, long mangizi)
    {
